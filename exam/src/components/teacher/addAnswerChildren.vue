      ...
      <el-tab-pane name="second">
        ...
        <div class="box">
          <ul>
            ...
            <li>
              <span>简单选择题数量：</span>
              <el-input type="text" v-model="esayChangeNumber"></el-input>
              <span style="margin-left: 20px">一般选择题数量：</span>
              <el-input type="text" v-model="commonChangeNumber"></el-input>
              <span style="margin-left: 20px">困难选择题数量：</span>
              <el-input type="text" v-model="difficultyChangeNumber"></el-input>
              <span style="margin-left: 20px">选择题分数：</span>
              <el-input type="text" v-model="changeScore"></el-input>
            </li>
            <li>
              <span>简单填空题数量：</span>
              <el-input type="text" v-model="esayFillNumber"></el-input>
              <span style="margin-left: 20px">一般填空题数量：</span>
              <el-input type="text" v-model="commonFillNumber"></el-input>
              <span style="margin-left: 20px">困难填空题数量：</span>
              <el-input type="text" v-model="difficultyFillNumber"></el-input>
              <span style="margin-left: 20px">填空题分数：</span>
              <el-input type="text" v-model="fillScore"></el-input>
            </li>
            <li>
              <span>简单判断题数量：</span>
              <el-input type="text" v-model="esayJudgeNumber"></el-input>
              <span style="margin-left: 20px">一般判断题数量：</span>
              <el-input type="text" v-model="commonJudgeNumber"></el-input>
              <span style="margin-left: 20px">困难判断题数量：</span>
              <el-input type="text" v-model="difficultyJudgeNumber"></el-input>
              <span style="margin-left: 20px">判断题分数：</span>
              <el-input type="text" v-model="judgeScore"></el-input>
            </li>
            <li>
              <span>简单简答题数量：</span>
              <el-input type="text" v-model="esayShorNumber"></el-input>
              <span style="margin-left: 20px">一般简答题数量：</span>
              <el-input type="text" v-model="commonShorNumber"></el-input>
              <span style="margin-left: 20px">困难简答题数量：</span>
              <el-input type="text" v-model="difficultyShorNumber"></el-input>
              <span style="margin-left: 20px">简答题分数：</span>
              <el-input type="text" v-model="shorScore"></el-input>
            </li>
    ...
    create() {
      this.$axios({
        ...
        data: {
          ...
          subject: this.subjects, // 指定科目随机组卷
