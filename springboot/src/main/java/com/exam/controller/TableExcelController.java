...
public class TableExcelController {
    ...
    @Autowired
    private TableExcelServiceImpl
            tableExcelService;
    @GetMapping("/tableExcel/{examCode}")
//    public ApiResult getTableExcel(@PathVariable("examCode") Integer examCode) {
//        System.out.println("getTableExcel");
//        List<TableExcel> tableExcel = tableExcelService.getTableExcel(examCode);
////        将tableExcel导出成excel表格然后传给前端
//
